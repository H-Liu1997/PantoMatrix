...
# python single_reconstruction_3k_check.py --cache_dir /home/weili/outputs/20250311_123449_drop0310-hdtf-same-check/test_200000/speaker_only/ --save_dir /home/weili/outputs/20250311_123449_drop0310-hdtf-same-check/test_200000/speaker_only/rec_check/
for latent_file in tqdm(os.listdir(motion_latent_dir)):
    if not latent_file.endswith(".npz"):
        continue
    file_name = latent_file[:-13]
    ...
    tgt_latent = np.load(os.path.join(motion_latent_dir, latent_file), allow_pickle=True)["random_data"]
