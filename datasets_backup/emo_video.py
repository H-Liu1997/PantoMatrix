...
if __name__ == "__main__":
    ...
    for idx, data in tqdm(enumerate(dataloader)):
        if data["video_id"][0] == -1:
            ...
            continue
        if os.path.exists(f"/home/weili/haiyang/PantoMatrix/{args.dataset_name}/cache_latent_v1/{data['video_id'][0]}_{face_id}.npz"):
            continue
        face_video = data['face_video'][0]           # [64, 3, 512, 512]
        hybrid_video = data['hybrid_face_video'][0]  # [64, 3, 512, 512]
        
        os.makedirs(f"/home/weili/haiyang/PantoMatrix/{args.dataset_name}/cache_ori_v1", exist_ok=True)
        os.makedirs(f"/home/weili/haiyang/PantoMatrix/{args.dataset_name}/cache_facedet_v1", exist_ok=True)
        os.makedirs(f"/home/weili/haiyang/PantoMatrix/{args.dataset_name}/cache_latent_v1", exist_ok=True)
        visualize_single(face_video, f"/home/weili/haiyang/PantoMatrix/{args.dataset_name}/cache_ori_v1/{data['video_id'][0]}_{face_id}.mp4")
        visualize_single(hybrid_video, f"/home/weili/haiyang/PantoMatrix/{args.dataset_name}/cache_facedet_v1/{data['video_id'][0]}_{face_id}.mp4")
        motion_latent = get_motion_latent(f"/home/weili/haiyang/PantoMatrix/{args.dataset_name}/cache_facedet_v1/{data['video_id'][0]}_{face_id}.mp4", motion_encoder, device)
        np.savez(f"/home/weili/haiyang/PantoMatrix/{args.dataset_name}/cache_latent_v1/{data['video_id'][0]}_{face_id}.npz", random_data=motion_latent)
