    ...
    def __init__(self, args):
        ...
        if self.rank==0:
            if self.args.stat == "ts":
                ...
                wandb.init(project=args.project, entity=args.entity, dir=args.out_path, name=args.name[12:] + args.notes)
...
def main_worker(rank, world_size, args):
    ...
    if rank == 0:
        ...
        if 'fid' in trainer.tracker.values:
            fid_test = trainer.tracker.values['fid']['test']['best']['value']
            wandb.log({"fid_test": fid_test})
